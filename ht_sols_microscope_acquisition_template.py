...
if __name__ == '__main__': # required block for sols_microscope
    ...
    dataz = ht_sols.DataZ() # create postprocessor for software autofocus
    ...
    folder_label = 'ht_sols_acquisition_template'
...
##    lr_move_mm = 1e-3 * scope.width_px * ht_sols.sample_px_um * move_pct / 100
